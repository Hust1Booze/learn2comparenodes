...
python problem_generation/problem_gen.py -data_partition train -n_instance 1000 -n_cpu 10
python problem_generation/problem_gen.py -data_partition valid -n_instance 100 -n_cpu 10
...
python node_selection/behaviour_gen.py -n_cpu 100 -problem WPMS -n_instance -1 
